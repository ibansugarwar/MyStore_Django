...
INSTALLED_APPS = [
    ...
    'base',  # 追記
    'django.contrib.humanize', # 金額カンマ区切りのため追記
]
...
DATABASES = {
    'default': {
        ...
        'NAME': env.str('SQL_DATABASE'), # データベース名
        'USER': env.str('SQL_USER_NAME'),
...
GOOGLE_GEOCODING_API_KEY = env.str('GOOGLE_GEOCODING_API_KEY')