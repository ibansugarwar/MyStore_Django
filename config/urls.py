...
urlpatterns = [
    ...
    path('order_cancel/', views.CustomerOrderCancelView.as_view()),
    ...
    # 会社情報
    path('company/', views.CompanyView),

    # 発送管理
    path('shipp/', views.ShippOrderIndexView.as_view()),
    path('shipp_complete/', views.ShippCompleteView.as_view()),
    path('shipp_cancel/', views.OperationOrderCancelView.as_view()),
